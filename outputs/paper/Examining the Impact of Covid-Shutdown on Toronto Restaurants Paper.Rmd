...
The sampling size for both the control and treated groups are set to 2000 to accommodate for the 5 cities identified (see Appendix I), the number is way beyond the minimum sampling size of 380 calculated from Equation 1. 
